...
@push('styles')
<style>
/* Business Page - Professional Storefront Design */
.bp-wrapper {
    min-height: 100vh;
    background: #f8fafc;
    padding-bottom: 4rem;
...
/* Products Section - full width, centered layout */
.bp-products-section {
    min-width: 0;
    width: 100%;
}
...
.bp-about-text::-webkit-scrollbar {
    width: 6px;
}
.bp-about-text::-webkit-scrollbar-track {
    background: #f1f5f9;
    border-radius: 3px;
}
.bp-about-text::-webkit-scrollbar-thumb {
    background: #cbd5e1;
    border-radius: 3px;
}
.bp-social-row {
