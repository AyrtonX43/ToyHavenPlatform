...
<div class="card mb-4">
    ...
    <div class="card-body">
        <form method="GET" action="{{ route('moderator.trade-listings.index') }}" class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-5 d-flex align-items-end gap-2 flex-wrap">
                ...
                <a href="{{ route('moderator.trade-listings.index') }}" class="btn btn-outline-secondary">Clear</a>
                <a href="{{ route('moderator.trade-listings.index', ['status' => 'pending_approval']) }}" class="btn btn-warning btn-sm"><i class="bi bi-hourglass-split me-1"></i> Pending</a>
                <a href="{{ route('moderator.trade-listings.index', ['status' => 'active']) }}" class="btn btn-success btn-sm"><i class="bi bi-check2-square me-1"></i> Approved</a>
                <a href="{{ route('moderator.trade-listings.index', ['status' => 'rejected']) }}" class="btn btn-danger btn-sm"><i class="bi bi-x-circle me-1"></i> Rejected</a>
            </div>
        </form>
    </div>
</div>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <span class="badge bg-info">{{ str_replace('_', ' ', ucfirst($listing->trade_type ?? 'barter')) }}</span>
                        </td>
                        <td class="align-middle">
                            @php
                        ...
                        <td class="align-middle text-end">
                            <div class="d-flex justify-content-end gap-1 flex-wrap">
                                <a href="{{ route('moderator.trade-listings.show', $listing->id) }}" class="btn btn-sm btn-outline-primary" title="View">
                                    <i class="bi bi-eye"></i>
                                </a>
                                @if($listing->status === 'pending_approval')
                                    ...
                                    <button type="button" class="btn btn-sm btn-danger" title="Reject" data-bs-toggle="modal" data-bs-target="#rejectModal" data-reject-url="{{ route('moderator.trade-listings.reject', $listing->id) }}" data-listing-title="{{ e($listing->title) }}">
