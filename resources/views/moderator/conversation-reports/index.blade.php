...
@section('title', 'Conversation Reports - Moderator')
@section('page-title', 'Conversation Reports')

@section('content')
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Trade chat reports</h5>
        <form method="GET" action="{{ route('moderator.conversation-reports.index') }}" class="d-flex gap-2">
                ...
                <tbody>
                    @forelse($reports as $report)
                        <tr>
                            ...
                            <td><a href="{{ route('moderator.conversation-reports.show', $report) }}" class="btn btn-sm btn-outline-primary">View</a></td>
                        </tr>
                    @empty
