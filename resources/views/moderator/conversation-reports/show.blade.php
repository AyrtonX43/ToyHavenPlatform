...
@section('title', 'Conversation Report #' . $report->id . ' - Moderator')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                @if($report->conversation && $report->conversation->tradeListing)
                    <p><strong>Listing:</strong> <a href="{{ route('trading.listings.show', $report->conversation->tradeListing->id) }}" target="_blank">{{ $report->conversation->tradeListing->title }}</a></p>
                @endif
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('moderator.conversation-reports.update', $report) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
