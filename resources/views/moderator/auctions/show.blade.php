...
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('moderator.auctions.index') }}">Auctions</a></li>
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-body">
                    <h2>{{ $auction->title }}</h2>
                    <span class="badge
                        @if($auction->status === 'pending_approval') bg-warning text-dark
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    @if($auction->status === 'pending_approval')
                        <hr>
                        <form action="{{ route('moderator.auctions.approve', $auction) }}" method="POST" class="mb-2">
                            @csrf
...
<div class="modal fade" id="rejectModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('moderator.auctions.reject', $auction) }}" method="POST">
                @csrf
