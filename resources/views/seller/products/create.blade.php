                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">You can upload up to 10 images. First image will be the primary image. Images imported from Amazon reference will be added automatically.</small>
                            @error('images')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            @error('images.*')
        ...
        .then(data => {
            if (data.success && data.results && data.results.length > 0) {
                ...
                data.results.forEach((product, index) => {
                    ...
                    const productImage = imageUrl ? `<img src="${imageUrl}" alt="${(product.title || 'Product').replace(/"/g, '&quot;')}" class="img-thumbnail" style="max-width: 120px; max-height: 120px; object-fit: contain;" onerror="this.onerror=null; this.parentElement.innerHTML='<div class=\\'bg-light d-flex align-items-center justify-content-center\\' style=\\'width: 120px; height: 120px;\\'><i class=\\'bi bi-image text-muted\\'></i></div>';">` : '<div class="bg-light d-flex align-items-center justify-content-center" style="width: 120px; height: 120px;"><i class="bi bi-image text-muted"></i></div>';
