...
@media (min-width: 768px) { .bp-product-grid { grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 1.75rem; } }
@media (min-width: 1200px) { .bp-product-grid { grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 2rem; } }
...
.bp-product-img { aspect-ratio: 1; background: #f8fafc; overflow: hidden; display: flex; align-items: center; justify-content: center; min-height: 220px; }
.bp-product-img img { width: 100%; height: 100%; object-fit: contain; object-position: center; }
