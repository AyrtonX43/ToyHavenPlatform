                    ...
                    <li class="nav-item">
                        @auth
                            @if(auth()->user()->hasActiveMembership())
                                <a class="nav-link {{ request()->routeIs('auction.*') ? 'active' : '' }}" href="{{ route('auction.index') }}">
                                    <i class="bi bi-hammer me-1"></i>Auction
                                </a>
                            @else
                                <a class="nav-link" href="{{ route('membership.index') }}">
                                    <i class="bi bi-gem me-1"></i>Membership Plan
                                </a>
                            @endif
                        @else
                            <a class="nav-link" href="{{ route('membership.index') }}">
                    ...
                    @auth
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0" style="min-width: 220px;">
                                ...
                                <li><a class="dropdown-item" href="{{ auth()->user()->hasActiveMembership() ? route('membership.manage') : route('membership.index') }}"><i class="bi bi-gem me-2"></i>{{ auth()->user()->hasActiveMembership() ? 'Manage Membership' : 'Membership' }}</a></li>
                                @if(Auth::user()->isSeller() && Auth::user()->seller && Auth::user()->seller->verification_status !== 'rejected')
                                    <li><hr class="dropdown-divider"></li>
