...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - ToyHaven</title>
            ...
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="{{ route('admin.dashboard') }}">
                        ...
                        <span class="ms-2 text-gradient-primary fw-bold">ToyHaven Admin</span>
                    </a>
                </h1>
                <div class="navbar-nav flex-row order-md-last">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown">
                            <span class="avatar avatar-sm" style="background-image: url(https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=0891b2&color=fff)"></span>
                ...
                <div class="navbar navbar-light">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown {{ request()->routeIs('admin.sellers.*') ? 'active' : '' }}">
                                <a class="nav-link dropdown-toggle" href="#navbar-sellers" data-bs-toggle="dropdown" role="button">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ route('admin.sellers.index') }}">All Sellers</a>
                                    <a class="dropdown-item" href="{{ route('admin.sellers.pending') }}">Pending Approval</a>
                                    <a class="dropdown-item" href="{{ route('admin.sellers.suspended') }}">Suspended</a>
                                </div>
                            </li>
                            ...
                            <li class="nav-item {{ request()->routeIs('admin.moderators.*') ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('admin.moderators.index') }}">
                                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                                        <i class="ti ti-shield-check"></i>
                                    </span>
                                    <span class="nav-link-title">Moderators</span>
                                </a>
                            </li>
