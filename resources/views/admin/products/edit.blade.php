            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    @if($product->amazon_reference_image)
                        <small class="text-muted d-block mt-1">Preview (1080P-4K HDR · 2500×2500px):</small>
                        <img src="{{ $product->amazon_reference_image }}" alt="Reference" class="img-thumbnail mt-1" style="width: 2500px; height: 2500px; max-width: 100%; height: auto; object-fit: contain;" onerror="this.style.display='none'">
                    @endif
                </div>
                <div class="col-md-6">
